...
<div class="main-wrap">
		...
		<nav class="side-menu content mCustomScrollbar" data-mcs-theme="minimal-dark">
			...
			<ul>
				...
				<li>
					<dl>
						<dt>
							<i class="icon-inbox"></i>开题分组管理<i class="icon-angle-right"></i>
						</dt>
						<dd>
				...
				<li>
					<dl>
						<dt>
							<i class="icon-table"></i>答辩分组管理<i class="icon-angle-right"></i>
						</dt>
						<dd>
				...
				<li>
					<dl>
						<dt>
							<i class="icon-list-alt"></i>学年论文管理<i class="icon-angle-right"></i>
						</dt>
						<dd>
				...
				<li>
					<dl>
						<dt>
							<i class="icon-external-link"></i>科研训练管理<i class="icon-angle-right"></i>
						</dt>
						<dd>
				...
				<li>
					<dl>
						<dt>
							<i class="icon-bar-chart"></i>实习信息管理<i class="icon-angle-right"></i>
						</dt>
						<dd>
				...
				<li>
					<dl>
						<dt>
							<i class="icon-font"></i>教师信息管理<i class="icon-angle-right"></i>
						</dt>
						<dd>
				...
				<li>
					<dl>
						<dt>
							<i class="icon-road"></i>班级学生管理<i class="icon-angle-right"></i>
						</dt>
						<dd>
				...
				<li>
					<dl>
						<dt>
							<i class="icon-tags"></i>课程教材管理<i class="icon-angle-right"></i>
						</dt>
						<dd>
	...
	<div class="content-wrap">
		<header class="top-hd">
			...
			<div class="hd-rt">
				<ul>
					...
					<li>
						<a><i class="icon-user"></i>管理员:<em>教务管理员</em></a>
					</li>
					<li>
		...
		<main class="main-cont content mCustomScrollbar">
			...
			<div class="page-wrap">
				<section class="page-hd">
					<header>
						<h2 class="title"><i class="icon-home"></i>长春理工大学经济管理学院综合教务系统</h2>
						<p class="title-description">
							本项目第一期工程建设为论文管理系统，自由打造个性化后台管理系统,
							<em class="text-primary">HTML5</em>+<em class="text-primary">CSS3</em>经典组合;
							本系统原型由<a class="text-primary" title="DeathGhost.cn">吉林大学史振坤</a>个人提供,仅供参考。
						</p>
					</header>
					<hr>
				</section>
		...
		<footer class="btm-ft">
			<p class="clear">
				<span class="fl">©Copyright 2016 <a href="#" title="DeathGhost" target="_blank">长春理工大学经济管理学院</a></span>
